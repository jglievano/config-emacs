...
(let ((colors '((fg1 "#d0d0d0")
      ...
      (faces '(;; default
	       ...
	       (mode-line-inactive :foreground ,c-24 :background ,c-37)
               ...
               (org-level-1 :inherit bold :foreground ,org-h1)
               (org-level-2 :inherit bold :foreground ,org-h2)
               (org-level-3 :bold nil :foreground ,org-h3)
               (org-level-4 :bold nil :foreground ,org-h4)
               (org-level-5 :bold nil :foreground ,org-h5)
               (org-level-6 :bold nil :foreground ,org-h6)
               (org-level-7 :bold nil :foreground ,org-h7)
               (org-level-8 :bold nil :foreground ,org-h8)
